...
class default_1 extends BaseInstruction_1.BaseInstruction {
    constructor() {
        super(...arguments);
        this.patterns = (0, makePattern_1.default)(/\$encodeURI/);
        this.description = 'Encodes a text string as a valid Uniform Resource Identifier (URI)';
        this.identifier = 'bdjs:encodeURI';
        this.version = '2.0.0';
    ...
    resolve({ inside = '' }) {
        return new Nodes_1.CallNode({
            callee: new Nodes_1.LiteralNode('encodeURI'),
