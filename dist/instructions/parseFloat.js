...
class default_1 extends BaseInstruction_1.BaseInstruction {
    constructor() {
        super(...arguments);
        this.patterns = (0, makePattern_1.default)(/\$parseFloat/);
        this.description = 'Converts a string to a floating-point number.';
        this.identifier = 'bdjs:parseFloat';
        this.version = '2.0.0';
    ...
    resolve({ inside = '' }) {
        return new Nodes_1.CallNode({
            callee: new Nodes_1.LiteralNode('parseFloat'),
