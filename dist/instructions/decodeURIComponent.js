...
class default_1 extends BaseInstruction_1.BaseInstruction {
    constructor() {
        super(...arguments);
        this.patterns = (0, makePattern_1.default)(/\$decodeURIComponent/);
        this.description = 'Gets the unencoded version of an encoded component of a Uniform Resource Identifier (URI).';
        this.identifier = 'bdjs:decodeURIComponent';
        this.version = '2.0.0';
    ...
    resolve({ inside = '' }) {
        return new Nodes_1.CallNode({
            callee: new Nodes_1.LiteralNode('decodeURIComponent'),
